...
function BekleyenContent() {
  ...
  const loadNumaralar = async () => {
    try {
      ...
      params.append('gonderildi', '0'); // Bekleyen = 0
      if (searchTerm) {
      ...
      if (response.ok) {
        ...
        const newUrl = `/numara/bekleyen?${params.toString()}`;
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <Text className="mt-1 text-gray-500">
            Henüz mesaj gönderilmemiş numaraları görüntüleyin
          </Text>
        </div>
      </div>
