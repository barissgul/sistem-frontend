...
function TamamlananContent() {
  ...
  const loadNumaralar = async () => {
    try {
      ...
      params.append('gonderildi', '1'); // Tamamlanan = 1
      if (searchTerm) {
      ...
      if (response.ok) {
        ...
        const newUrl = `/numara/tamamlanan?${params.toString()}`;
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <Title as="h2" className="text-2xl font-bold">
            Tamamlanan Numaralar
          </Title>
          <Text className="mt-1 text-gray-500">
            Başarıyla gönderilen numaraları görüntüleyin
          </Text>
        </div>
      </div>
